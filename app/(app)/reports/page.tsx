...
import { cn, formatDate, formatRelativeTime, getScoreColor } from '@/lib/utils';
    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: 'Ready', value: mockReports.filter(r => r.status === 'ready').length },
          { label: 'Generating', value: mockReports.filter(r => r.status === 'generating').length },
        ].map((stat, i) => (
